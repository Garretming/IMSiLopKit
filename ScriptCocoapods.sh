...
#  ScriptCocoapods.sh
#  IMSiLopKit。 推荐使用这个脚本打包
# demo 验证时，要将验证demo,使用Cocoapods 管理，新建Podfile 文件，pod YYModel 依赖第三方库YYModel，否则会找不到YYModel.h
# 在目标工程 #import<IMSiLopKit/IMSiLopKit.h>
#  Created by clark on 2021/6/10.
#

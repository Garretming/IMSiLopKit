...
#import <ALBBOpenAccountSDK/ALBBOpenAccountRegionModel.h>
#else
...
#import <ALBBOpenAccountCloud/ALBBOpenAccountRegionModel.h>
#endif
...
#ifndef ALBBOpenAccountIdcParamGet
#define ALBBOpenAccountIdcParamGet                  @"ALBBOA_NOTIFICATION_IDCPARAM_GET"
#endif
...
#ifndef ALBBOpenAccountNotificationTrigerByLogin
#define ALBBOpenAccountNotificationTrigerByLogin                  @"ALBBOA_NOTIFICATION_TRIGER_BY_LOGIN"
#endif

#ifndef ALBBOpenAccountNotificationTrigerByRSTPASSWD
#define ALBBOpenAccountNotificationTrigerByRSTPASSWD                  @"ALBBOA_NOTIFICATION_TRIGER_BY_RESETPASSWD"
#endif

#ifndef ALBBOpenAccountNotificationTrigerByFindPASSWD
#define ALBBOpenAccountNotificationTrigerByFindPASSWD                  @"ALBBOA_NOTIFICATION_TRIGER_BY_FINDPASSWD"
#endif

#ifndef ALBBOpenAccountNotificationTrigerByREG
#define ALBBOpenAccountNotificationTrigerByREG                  @"ALBBOA_NOTIFICATION_TRIGER_BY_REG"
#endif
...
- (ALBBOpenAccountRegionModel*)getRegionModel;

- (void)setRegionModel:(ALBBOpenAccountRegionModel*)regionModel;
/**
 设置语言环境，不设置默认简体中文
...
/**
 设置统一服务中心host
 @param host 统一服务中心host
 */
- (void)setIdcHost:(NSString *)host;

/**
设置是否启用idchost，默认是enable
@param enable， true为启用，false为不y启用
*/
- (void)enableIdcHost:(bool)enable;
/**
 如果使用了统一服务中心，注册新账号需要指定region
 @param regionId  账号服务器id
 */
- (void)setRegion:(NSString *)regionId;
